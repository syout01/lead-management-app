        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              {lead.contactName} / {lead.contactTitle || "役職未設定"}
            </p>
          </div>
        </div>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">{lead.contactTitle}</p>
                </div>
              </div>
              {lead.contactEmail && (
                <div className="flex items-center gap-3 text-sm">
          ...
          <Card className="border-0 shadow-sm">
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-500">リードソース</span>
                <span className="font-medium">{lead.source || "-"}</span>
              </div>
              <Separator />
              <div className="flex justify-between">
                <span className="text-gray-500">自社担当</span>
              ...
              <Separator />
              <div className="flex justify-between">
                <span className="text-gray-500">次回アクション日</span>
              ...
              <Separator />
              <div className="flex justify-between">
                <span className="text-gray-500">アポ日</span>
                <span className="font-medium">
