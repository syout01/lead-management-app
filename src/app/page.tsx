...
import { fetchStats, fetchTodayLeads, fetchAllActivities } from "@/lib/use-store";
import { Lead, Activity, LEAD_STATUS_LABELS, LEAD_STATUS_COLORS } from "@/lib/types";
...
export default function DashboardPage() {
  ...
  const loadData = useCallback(async () => {
    try {
      const [s, tl, acts] = await Promise.all([
        fetchStats(),
        fetchTodayLeads(),
        fetchAllActivities(),
      ]);
